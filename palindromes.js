...
function longestPalindromicSubstring(str) { 
    ...
    console.log(longestPalindromicSubstring(str5)); // expected "dad"
    console.log(longestPalindromicSubstring(str6)); // expected "u"
    console.log(longestPalindromicSubstring(str7)); // expected "e racecar e"
    console.log(longestPalindromicSubstring(str8)); // expected "5677765"
    console.log(longestPalindromicSubstring(str9)); // expected "5677765"